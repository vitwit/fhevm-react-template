 ...
 */
export function isFhevmRelayerSDKType(obj, trace) {
    ...
    if (typeof sdk.createInstance !== "function")
        return false;
    if ("__initialized__" in sdk && typeof sdk.__initialized__ !== "boolean")
        return false;
    return true;
}
/**
 ...
 */
export function isFhevmWindowType(win, trace) {
